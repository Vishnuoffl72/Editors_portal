    ...
    <main className="Postpagebase">
      ...
      <div className="container postcontainer">
        <form action="" className="postform" onSubmit={Submit} >
          ...
          <div className="row">
            <div className="col-6">
              <label for="name" className="form-label">Social Media handle:</label>
              <input type="text"
                id="name"
                className="form-control"
            ...
            <div className="col-6">
                <label for="inp_destination" className="form-label">Video Duration:</label>
                <input type="text"
                  id="inp_destination"
                  className="form-control"
          ...
          <div className="row">
            <div className="col-6">
              <label htmlFor="inp_price" className="form-label">Orientation:</label>
              <input type="text" 
                id="inp_price"
                className="form-control"
            ...
            <div className="col-6">
              <label htmlFor="inp_weight" className="form-label">Slots:</label>
              <input type="text"
                id="inp_weight"
                className="form-control"
